  ...
  return (
    <div className="">
      <div className="border-b-2 border-blue-800 w-[70%] mb-3 ml-5 mt-1">
        <h2 className="font-medium text-blue-700 ml-3">Nudge Template</h2>
      </div>
      <form
          ...
          <div className="space-y-1">
            ...
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                <div>
                  <textarea
                    className="bg-gray-50 outline-none border-[0.03rem] rounded-[0.250rem] p-1 w-full border-gray-400 focus:border-blue-500 focus:border-[0.158rem] "
                    cols={50}
          ...
          <div className="space-y-1">
            ...
            <Controller
              ...
              render={({ field }) => (
                <select
                  {...field}
                  className="bg-gray-50 outline-none border-[0.03rem] rounded-[0.250rem] p-1  border-gray-400 focus:border-blue-500 focus:border-[0.158rem] "
                  onClick={(event) =>
